...
const footerColumns = [
  {
    title: "Product",
    links: ["Features", "Pricing", "Documentation", "Changelog", "API"],
  },
  {
    title: "Company",
...
const socialLinks = [
  ...
  {
    label: "GitHub",
    href: "https://github.com/stratifyx",
    icon: (
      <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "Discord",
    href: "https://discord.gg/stratifyx",
    icon: (
      <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center gap-2">
              {socialLinks.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  className="flex h-8 w-8 items-center justify-center rounded-md text-sx-text-dim transition-colors duration-200 hover:text-sx-text hover:bg-sx-surface"
                >
                  {s.icon}
                </a>
              ))}
